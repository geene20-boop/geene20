    ...
    <div className="bg-white rounded-xl border p-5 flex flex-col gap-3">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          ...
          새로 쌓입니다. 다시 업로드해도 같은 품목은 재고 수량(및 생산누계, 값이 있는 경우)만
          최신값으로 덮어씁니다. 구글시트에 &quot;생산누계&quot; 열을 직접 추가해서 쓰고 계셨다면,
          그 열도 그대로 함께 업로드하시면 과거 누계값이 처음 한 번 반영되고, 이후부터는 이 앱에서
          생산(포장) 입력을 할 때마다 자동으로 누적됩니다.
        </p>
      </div>
      {admin.loggedIn ? (
