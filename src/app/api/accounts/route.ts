...
export async function POST(req: NextRequest) {
  ...
  const menuGroupId = body.menuGroupId != null ? Number(body.menuGroupId) : null;
  ...
  try {
    const account = createAccount(username, password, role, displayName, workerId, menuGroupId);
