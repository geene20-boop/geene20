...
import { getOffsiteBackupLastSync, isOffsiteBackupConfigured } from "@/lib/offsiteBackup";
...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({
    backups: listBackups(),
    emailConfigured: isBackupEmailConfigured(),
    offsiteConfigured: isOffsiteBackupConfigured(),
    offsiteLastSync: getOffsiteBackupLastSync(),
  });
}
