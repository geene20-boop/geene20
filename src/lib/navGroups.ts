...
// [개선계획] 화면에서 관리자(공용 비밀번호)와 동일하게 완료 승인/반려를 할 수 있는 특정 개인(이름).
// 근로자 단위의 세부 권한 체계가 아직 없어 이름을 그대로 매칭한다.
export const IMPROVEMENT_PLAN_ADMIN_DISPLAY_NAMES = new Set(["박성준"]);
